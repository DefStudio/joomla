...
<tr class="krow<?php echo $this->row . $txt;?> krow<?php echo $this->row . $txt . $this->topic->getCategory()->class_sfx;?>">
	...
	<td class="kcol-mid kcol-ktopictitle">
		...
		<div class="visible-phone">
			...
			<?php echo JText::_('COM_KUNENA_BY') . ' ' . $this->topic->getLastPostAuthor()->getLink(null, null, '', '', KunenaTemplate::getInstance()->tooltips(), $category->id);?>
			<div class="pull-right">
				<?php /** TODO: New Feature - LABELS
				<span class="label label-info">
				<?php echo JText::_('COM_KUNENA_TOPIC_ROW_TABLE_LABEL_QUESTION'); ?>
